...
public class AubeViewContext extends ViewToolContext {
	private ViewContextDebugger gvd;
	public AubeViewContext(VelocityEngine velocity, HttpServletRequest request, HttpServletResponse response, ServletContext application) {
