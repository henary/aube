...
public class JsonLogger extends LoggerWrapper implements Logger, AubeLogger {
	...
	public enum Level {
		TRACE("TRACE", LocationAwareLogger.TRACE_INT), DEBUG("DEBUG", LocationAwareLogger.DEBUG_INT), INFO("INFO",
	...
	public JsonLogger(Logger logger, String serverIp2, String systemId2) {
		// If class B extends A, assuming B does not override method x(), the
		// caller
